...
import { useStore, Currencies, ExchangeDirection } from "./store";
...
const ExchangeRate: VFC<ExchangeRateProps> = ({ from, to, ...rest }) => {
...
const Balance: VFC<BalanceProps> = ({ currency, ...rest }) => {
